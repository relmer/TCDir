...
public:
    ...
    static void    DisplayUsage                     (CConsole & console, wchar_t chPrefix = L'-', optional<bool> fIconsCli = nullopt);
    static void    DisplayEnvVarHelp                (CConsole & console, wchar_t chPrefix = L'-');
    static void    DisplayConfigFileHelp            (CConsole & console, wchar_t chPrefix = L'-');
    static void    DisplaySettings                  (CConsole & console, wchar_t chPrefix = L'-', optional<bool> fIconsCli = nullopt);
    static void    DisplayConfigFileIssues          (CConsole & console, wchar_t chPrefix = L'-', bool fShowHint = true);
...
private:
    ...
    static void    DisplaySynopsis                           (CConsole & console, const vector<wstring> & tokens);
    ...
    static void    DisplayItemAndSource                      (CConsole & console, wstring_view item, WORD attr, CConfig::EAttributeSource source, size_t columnWidthItem, size_t columnWidthSource, size_t cxColumnWidth, EItemDisplayMode mode, wstring_view iconPrefix = L"", bool fShowIcons = false);
